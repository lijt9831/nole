...
public abstract class SqlFormatter {
	...
	/**
	 * Formats a blob to the following String
	 * "'<Blob length = " + blob.length()+">'" This method's output will not
	 * translate directly into the database. It is informational only.
	 * 
	 * @param blob
	...
	/**
	 * Formats a clob to the following String
	 * "'<Clob length = " + clob.length()+">'" This method's output will not
	 * translate directly into the database. It is informational only.
	 * 
	 * @param clob
	...
	/**
	 * Formats a Ref to the following String "ref.getBaseTypeName()" This method's
	 * output will not translate directly into the database. It is informational
	 * only.
	 * 
	 * @param ref
	...
	/**
	 * If object is null, Blob, Clob, Array, Ref, or String this returns the value
	 * from the protected methods in this class that take those Classes.
	 * 
	 * @param o
